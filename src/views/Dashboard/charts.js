      ...
      <Box p={4} bg="gray.100" borderRadius="lg" boxShadow="lg">
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Box>
            ...
            <Text fontSize="2xl">{data.users_count}</Text>
          </Box>
          <Box>
          ...
          <Box>
            <Text fontSize="lg" fontWeight="bold">Total Outcome</Text>
            <Text fontSize="2xl">${data.total_outcome}</Text>
          </Box>
          <Box>
            <Text fontSize="lg" fontWeight="bold">Total Profit</Text>
            <Text fontSize="2xl">${data.total_income - data.total_outcome}</Text>
          </Box>
          <Box>
